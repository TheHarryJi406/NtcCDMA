...
<%
String pageName = "changePasswordByAdmin.jsp";
...
if (changeButton != null) {
	...
	if (userAllDao.changePasswordByAdmin(userName.toUpperCase(), newPassword)) {
			...
			<form id="form1" action="" method="post">
				<table>
					<tr>
						...
						<td>User Name</td>
						<td><input type="text" name="userName" id="userName"  class="userName" title="Enter User Name "></td>
					</tr>		
					<tr>
						<td>New Password</td>
