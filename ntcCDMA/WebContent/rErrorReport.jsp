...
String pageName = "rErrorReport.jsp";
...
// 		String tempTransType="";
		...
		String url="../WebViewerExample/frameset?__report=cdmaReport/errorReport.rptdesign"+tempCollCen+"&fromDate="+fromDate+"&toDate="+toDate+"&createdBy="+user+tempAccCen+tempRegion;
		url = URLEncoder.encode(url);
		response.sendRedirect("rErrorReport.jsp?&url="+url);
		return;
		}
...
<div>
	<form id="form1" action="rErrorReport.jsp" method="post">
		<table class="xform">
			<tr>
				<%		
