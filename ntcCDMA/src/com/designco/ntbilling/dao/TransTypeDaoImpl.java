...
public class TransTypeDaoImpl extends JdbcTemplate implements TransTypeDao {
...
*/
	@Override
	public List getAll() {
		String sql = "SELECT * FROM m_trans_type";
		return this.queryForList(sql);
	}

	/*@Override
	public List getByCode(String code) {
		String sql = "SELECT * FROM m_trans_type WHERE trans_cd = ?";
