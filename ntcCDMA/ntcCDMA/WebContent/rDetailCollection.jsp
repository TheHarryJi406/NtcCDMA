...
<%
String pageName = "rDetailCollection.jsp";
...
// 		String url="http://202.70.66.228/WebViewerExample/frameset?__report=rep/"+tempTransType+".rptdesign&fromDate="+fromDate+"&toDate="+toDate+"&userId="+user+
// 				tempFromAccountId+tempToAccountId+tempRegion+tempAccCen+tempCollCen;
		//System.out.println(url);
		String url="../WebViewerExample/frameset?__report=cdmaReport/detailCollectionByCounter.rptdesign"+tempCollCen+"&frmDate="+fromDate+"&toDate="+toDate+"&createdBy="+user+tempAccCen+tempRegion+tempClrk;
		url = URLEncoder.encode(url);
		response.sendRedirect("rDetailCollection.jsp?&url="+url);
		return;
		}
...
<h2>Detail Collection By Counter Clerk Receipt No. Wise</h2>
<br><br>
<!-- <div style="text-align: right;"><a href="region.jsp?mode=add" >Add new</a></div> -->
<div>
	<form id="form1" action="rDetailCollection.jsp" method="post">
		<table class="xform">
			<tr>
				<%		
