...
<%
String pageName = "rDaywiseCashColl.jsp";
...
if (menuAccessDao.checkMenuAccessForUser(userId, pageName)==false) {
	...
	if(request.getParameter("ok")!=null){
		...
		String url="../WebViewerExample/frameset?__report=cdmaReport/daywiseCashCollection.rptdesign"+tempCollCen+"&frmDate="+fromDate+"&toDate="+toDate+"&createdBy="+userName+tempAccCen+tempRegion+tempClrk;
// 		System.out.println(url);
		url = URLEncoder.encode(url);
			response.sendRedirect("rDaywiseCashColl.jsp?&url="+url);
			return;
...
<h2> Day Wise Cash Collection By Counter Clerk</h2>
<br><br>
<!-- <div style="text-align: right;"><a href="region.jsp?mode=add" >Add new</a></div> -->
<div>
	<form id="form1" action="rDaywiseCashColl.jsp" method="post">
		<table class="xform">
			<tr>
				<%		
