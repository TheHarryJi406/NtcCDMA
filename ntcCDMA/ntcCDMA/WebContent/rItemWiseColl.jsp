...
<%
String pageName = "rItemWiseColl.jsp";
...
if (menuAccessDao.checkMenuAccessForUser(userId, pageName)==false) {
	...
	if(request.getParameter("ok")!=null){
		...
		String url="../WebViewerExample/frameset?__report=cdmaReport/itemWiseCashCollectionSummary.rptdesign"+tempCollCen+"&frmDate="+fromDate+"&toDate="+toDate+"&createdBy="+user+tempAccCen+tempRegion+tempClrk;
		url = URLEncoder.encode(url);
		response.sendRedirect("rItemWiseColl.jsp?&url="+url);
		return;
		}
...
<h2>Item-wise Daily Cash Collection Summary By Cashier</h2><br><br>
<!-- <div style="text-align: right;"><a href="region.jsp?mode=add" >Add new</a></div> -->
<div>
	<form id="form1" action="rItemWiseColl.jsp" method="post">
		<table class="xform">
			<tr>
				<%		
