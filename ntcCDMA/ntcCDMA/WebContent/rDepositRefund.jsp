...
<%
String pageName = "rDepositRefund.jsp";
...
if (menuAccessDao.checkMenuAccessForUser(userId, pageName)==false) {
	...
	if(request.getParameter("ok")!=null){
		...
		String url="../WebViewerExample/frameset?__report=cdmaReport/depositRefund.rptdesign"+tempCollCen+"&frmDate="+fromDate+"&toDate="+toDate+"&createdBy="+user+tempAccCen+tempRegion+tempClrk;
		url = URLEncoder.encode(url);
		response.sendRedirect("rDepositRefund.jsp?&url="+url);
		return;
		}
...
<h2>Deposit Refund Report </h2><br><br>
<!-- <div style="text-align: right;"><a href="region.jsp?mode=add" >Add new</a></div> -->
<div>
	<form id="form1" action="rDepositRefund.jsp" method="post">
		<table class="xform">
			<tr>
				<%		
